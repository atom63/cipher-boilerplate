...
const RichButton = forwardRef<HTMLButtonElement, RichButtonProps>(
  ({ className, size, asChild = false, children, ...props }, ref) => {
    ...
    const primaryGlow =
      "color-mix(in srgb, var(--primary) 40%, transparent) 0px 8px 24px -4px";
    ...
    return (
      ...
      >
        ...
        <div
          className="pointer-events-none absolute inset-0 rounded-[inherit] transition-opacity duration-300 ease-out group-hover/rich-button:opacity-100 opacity-50"
          style={{
            background:
